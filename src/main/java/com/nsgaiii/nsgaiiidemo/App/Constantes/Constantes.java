...
public class Constantes {
	public static final String rutaGeneral = "{route in your computer}";
	
	public static final String rutaFicheros = rutaGeneral + "\\data\\\\CSV\\";
	public static final String rutaDatos = rutaGeneral + "\\data\\\\datos\\";
	public static final String rutaDatos_por_aeropuerto = rutaGeneral + "\\data\\\\datos\\datos_por_aeropuerto\\";
